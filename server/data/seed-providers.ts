...
// The 4 providers moved verbatim from the old frontend mock data (src/data.ts).
// This is the single source of truth for the seed; nothing in the UI imports it.
